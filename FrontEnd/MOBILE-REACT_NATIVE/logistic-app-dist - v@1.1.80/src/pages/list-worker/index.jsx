...
export default (props) =>{
    ...
    /**
     * possui um resultado parcial,
     * pois só retorna o valor do estado alterado no array,
     * e o campo vazio não me retorna os dados da requisição completa,
     * necessito de testes para melhorar a lógica da busca.
     * 
     */

    // function search(value){
    //     data.filter((e)=>{
    //         if(e.workerName === value){
    //             console.warn(value)
