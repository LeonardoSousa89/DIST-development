...
export default (props) =>{
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.internalContainer}>
          ...
          {/* <View style={styles.textMessage}>
            ...
            <Text style={styles.messageWith}>SignUp with</Text>          
          </View> */}
      ...
      {/* 
          nesta bateria de testes não utilizarei o footer,
          que utiliza o login com google
      */}
      {/* <View style={styles.footer}>
            <Footer method={createUserWithProvider} />
      </View> */}
