...
import { logOut, insertWorker, 
                getProfileData, 
                getProfilePhotoUploaded, 
                uploadProfilePhoto, 
                pagination, 
                getWorkersData} from '../../services'
...
export default (props) =>{
    ...
    const filterWorkers=data.filter((res)=>{ 
            const workerFiltered=res.workerName.indexOf(search)
            console.warn(workerFiltered)    
    })
